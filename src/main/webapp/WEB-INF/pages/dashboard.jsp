                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-card-data-container">
                                <div class="stat-card-data">
                                    ...
                                    <h3 class="stat-card-data-number">${ongoingEvents}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="stat-card">
                            ...
                            <div class="stat-card-data-container">
                                <div class="stat-card-data">
                                    ...
                                    <h3 class="stat-card-data-number">${upcomingEvents}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="stat-card">
                            ...
                            <div class="stat-card-data-container">
                                <div class="stat-card-data">
                                    ...
                                    <h3 class="stat-card-data-number">${completedEvents}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="stat-card">
                    ...
                    <div class="stat-tables">
                        <div class="top-interested-events">
                            ...
                            <div class="top-interested-events-list">
			                    <c:forEach var="event" items="${topInterestedEvents}">
			                        <div class="top-interested-events-data">
			                            <p><c:out value="${event.eventName}" /></p>
			                            <p><c:out value="${event.interestCount}" /></p>
			                        </div>
			                    </c:forEach>
			                </div>
                        </div>
                        ...
                        <div class="most-engaged-users">
                            ...
                            <div class="most-engaged-users-list">
                                <c:forEach var="user" items="${mostEngagedUsers}">
			                        <div class="most-engaged-users-data">
			                            <div class="most-engaged-users-data-info">
			                                <img class="most-engaged-users-data-img" src="${contextPath}/${user.profilePicturePath}" onerror="this.src='${contextPath}/resources/images/default-profile.png';" alt="Profile Picture"/>
			                                <div class="most-engaged-users-data-texts">
			                                    <p class="most-engaged-users-data-texts-name"><c:out value="${user.fullName}" /></p>
			                                    <p class="most-engaged-users-data-texts-email"><c:out value="${user.email}" /></p>
			                                </div>
			                            </div>
			                            <p class="most-engaged-users-data-stats"><c:out value="${user.engagementCount}" /></p>
			                        </div>
			                    </c:forEach>
                            </div>
                        </div>
