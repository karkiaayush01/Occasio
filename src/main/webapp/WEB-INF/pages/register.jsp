				...
				<form class="register-form" name="register-form">
					<div class="register-part-1">
						...
						<div class="form-section">
							...
							<input type="text" id="form-org" class="form-input">
						</div>
						<div class="form-section">
						...
						<div>
							<div class="form-section" style="margin-bottom: 4px;">
								...
								<div style="position: relative; width: 100%">
									<input type="password" id="create-password-field" class="form-input password">
							...
							<div class="form-section" style="margin-bottom: 32px;">
								...
								<div style="position: relative; width: 100%">
									<input type="password" id="confirm-password-field" class="form-input password">
