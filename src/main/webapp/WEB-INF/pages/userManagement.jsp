			...
			<div class = "side-bar">
				...
				<div class="side-bar-sub-menu">
					<div class="side-bar-sub-menu-items">
						...
						<button id="userManagementTabButton" class = "side-bar-sub-menu-items-item active" onClick="window.location.href='${contextPath}/userManagement'">User Management</button>
